      ...
      <div className="w-full max-w-md p-8">
        ...
        <div className="space-y-3">
          ...
          <button
            ...
            className="w-full flex items-center justify-center gap-3 px-4 py-3 bg-gray-800 rounded-lg hover:bg-gray-700 transition disabled:opacity-50 border border-gray-700"
          >
            <svg
              className="w-5 h-5"
              fill="currentColor"
